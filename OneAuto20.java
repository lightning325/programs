 ...
 */
public class OneAuto20 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (Support)
        {
            if (ColorRed)
            {
                ...
                {
                    telemetry.addData("", "Defensive, Red");
                    telemetry.update();
                }
            ...
            else
            {
                ...
                {
                    telemetry.addData("", "Defensive, Blue");
                    telemetry.update();
                }
        ...
        else
        {
            ...
            if (ColorRed)
            {
                ...
                if (BeaconFirst)
                {
                    ...
                    while (opModeIsActive()) {
                        DriveMotor1.setPower(-0.08);
                        DriveMotor2.setPower(-0.08);
                        DriveMotor3.setPower(-0.14);
                        DriveMotor4.setPower(-0.14);
    ...
    public void DriveInches(double power, int inches, boolean fw) {
        ...
        if (fw)
            DriveMotor1.setTargetPosition((int) (ticks / 2));
        else
            DriveMotor1.setTargetPosition((int) (-ticks / 2));
